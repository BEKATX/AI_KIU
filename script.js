const API_KEY = "AIzaSyBOQYDTTc4_Gs9PttoiKDoAdATFhVRNGWQ"; // Replace with your actual Gemini API key during local testing
...
window.addEventListener('load', () => {
  ...
  footer.textContent = `© 2025 Tkhilaishvili.Beka@kiu.edu.ge - ${today}`;
});
